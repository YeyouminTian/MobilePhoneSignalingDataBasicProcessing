...
DROP TABLE IF EXISTS nc_1_6_1_base_station_user_count;

CREATE TABLE IF NOT EXISTS nc_1_6_1_base_station_user_count (
    "DATE" DATE,
    "CGI" BIGINT,
    "USER_COUNT" BIGINT,
    "SIGNAL_COUNT" BIGINT
...
INSERT INTO nc_1_6_1_base_station_user_count
SELECT 
